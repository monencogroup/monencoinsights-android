...
public class PurchasedsFragment extends AbstractFragment implements OnModelListReceivedListener<Article>, View.OnClickListener {
    ...
    public void initialViews() {
        ...
        title.setText(getStringValue(R.string.purchaseds));
    ...
    private void fetch() {
        ...
        Request<Article> request = new Request<>(Request.METHOD_GET, URLs.ARTICLE + URLs.PURCHASE + URLs.LIST);
